...
def load_everything():
    ...
    # ── Load model ────────────────────────────
    try:
        # Use tf.keras.saving for cross-version compatibility
        ...
        # Older TF doesn't have safe_mode param
        try:
    ...
    # Always recompile fresh — avoids any saved optimizer/loss config issues
    model.compile(
