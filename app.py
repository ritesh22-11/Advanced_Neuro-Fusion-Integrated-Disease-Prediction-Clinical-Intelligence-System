...
def load_everything():
    ...
    try:
        ...
        # Patch the saved config to strip quantization_config
        # (added by Keras 3.4+ in Colab, not recognized by older Keras)
        ...
        # Custom objects to handle the patched Dense config
